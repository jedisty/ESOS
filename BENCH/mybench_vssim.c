...
#define DEVICE "/dev/sda5"
#define FILENAME    "/dev/sda5"
#define FILENAMESIO "/dev/sda5"
#define FILENAMEDIO "/dev/sda5"
#define FILENAMESYDI "/dev/sda5"
...
int main( int argc, char **argv)
{
	...
	if(argc!=5)
	{
	 		printf("Need 4 inputs : File size(KByte), reclen(KByte), AccessMode(0:WRITE, 1:REWRITE, 2:RANDOM_WRITE 3:RANDOM_READ), Sync Mode(0:Normal, 1: O_SYNC,  2: fsync   3: O_DIRECT    4: Sync+direct IO)\n\n");
	 		return;
	}	
