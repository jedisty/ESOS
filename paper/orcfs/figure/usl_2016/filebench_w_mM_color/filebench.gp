...
set terminal postscript eps enhanced color "Helvetica,48"  solid size 9,4
...
plot in1 using 2:3:4 t "Ext4" w hist lt -1, \
                 "" u 5:6:7 t "F2FS" w hist lt -1 fill pattern 4, \
                 "" u 8:9:10 t "OrcFS" w hist lc 1 lt -1 fill solid 
