...
struct bank_hw bank_hw[NR_PHY_BANKS];
struct bank_cmd bank_cmd[NR_PHY_BANKS];
...
enum hrtimer_restart flash_isr(struct hrtimer * ptr)
{
	...
	for (bank=0; bank<NR_PHY_BANKS; bank++) {
