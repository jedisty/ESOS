...
/* Practice: Declare global variables */
#ifdef F2FS_GET_FS_WAF
unsigned long long len_user_data = 0;	// the write length from user to FS
unsigned long long len_fs_write = 0;	// the write length from FS to the block layer
#endif
